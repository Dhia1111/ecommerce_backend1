...
namespace BusinessLayer
{
    internal class clsIncludedProduct
    {
        ...
        public DTOIncludedProducts DTOIncludedProduct { get { return new DTOIncludedProducts(this.ID, this.TransactionID, this.ProductID); } }

        public clsIncludedProduct(int TransactionID, int ProductID)
        {
            this.TransactionID=TransactionID;
            this.ProductID=ProductID;
        }

         clsIncludedProduct(int ID, int TransactionID, int ProductID)
        {
            this.ID = ID;
            this.TransactionID = TransactionID;
            this.ProductID = ProductID;
