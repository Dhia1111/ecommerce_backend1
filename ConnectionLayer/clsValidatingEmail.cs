...
namespace ConnectionLayer
{
    public static class clsValidatingEmail
    {
        public static async Task<DTOValidatingEmail?> Find(string GUID_ID)
        {
            ...
            string qery = "select top 1* From ValidatingEmail where ValidatingEmailID=@ValidatingEmailID";
        ...
        public static async Task<DTOValidatingEmail?> Find(int  PersonID)
        {
            ...
            string qery = "select top 1* From ValidatingEmail where PersonID=@PersonID";
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(clsConnectionGenral.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand(qery, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@ValidatingEmailID", ValidatingEmail.GUID_ID);
